...
# Linux/macOS
g++ -std=c++17 -O2 -pthread ftx1_server.cpp FTX1Controller.cpp FTX1HttpServer.cpp -o ftx1_server
./ftx1_server --port /dev/ttyUSB0 --baud 38400 --http 8080

# Windows (MSVC)
cl /std:c++17 /O2 /EHsc ftx1_server.cpp  FTX1Controller.cpp FTX1HttpServer.cpp /link ws2_32.lib
